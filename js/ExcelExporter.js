        ...
        return '<xml version="1.0" encoding="utf-8">' +
            ...
            '<ss:Styles>' +
                ...
                '<ss:Style ss:ID="headercell">' +
                    ...
                    '<ss:Interior ss:Pattern="Solid" ss:Color="#999999" />' +
                '</ss:Style>' +
                '<ss:Style ss:ID="even">' +
                    '<ss:Interior ss:Pattern="Solid" ss:Color="#D5E0E1" />' +
                '</ss:Style>' +
    ...
    // Calculate cell data types and extra class names which affect formatting
	    ...
	    var col = cm[i];	
			...
			headerXml += '<ss:Cell ss:StyleID="headercell">' +
			    '<ss:Data ss:Type="String">' + col.text + '</ss:Data>' +
			    '<ss:NamedCell ss:Name="Print_Titles" /></ss:Cell>';
			//var fld = this.store.recordType.prototype.fields.get(col.dataIndex);
					var model = this.store.getProxy().getModel();
					var flds = model.prototype.fields.keys;
					var fld = this.store.data.get(i).get(col.dataIndex);
					var type = typeof fld;
			switch(type) {
			    case "int":
                ...
                '<ss:Row ss:Height="38">' +
                    '<ss:Cell ss:StyleID="title" ss:MergeAcross="' + (visibleColumnCount - 1) + '">' +
                      '<ss:Data xmlns:html="http://www.w3.org/TR/REC-html40" ss:Type="String">' +
                        '<html:B>Generated by DIG</html:B></ss:Data><ss:NamedCell ss:Name="Print_Titles" />' +
                    '</ss:Cell>' +
                '</ss:Row>' +
